function spherefit = fun_MaxFilter_RDKPD(settings)
%at- modified version of Rik Henson's MaxFilter2pt2_CC
...
cd(settings.maxfld);%needed otherwise files will be saved heaven knows where...
