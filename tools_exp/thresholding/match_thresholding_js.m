...
[~,low_threshold] = doPsignifit(test2,low_threshold_pc); % new way of getting unscaled thresholds that obviates the need for some of the crazy indexing into the plotline I was doing below
...
[~,low_threshold] = doPsignifit(test2,low_threshold_pc);
...
% make a sigmoid and put it on a figure
[~,low_threshold] = doPsignifit(test1,low_threshold_pc); % new way of getting unscaled thresholds that obviates the need for some of the crazy indexing into the plotline I was doing below
high_threshold = -90-low_threshold; % this is the inverse of the low_threshold value - currently I've flipped everything into negative so it is oriented correctly in the psignifit tools
