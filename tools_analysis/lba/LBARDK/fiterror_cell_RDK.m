...
[num_param,parLL,parHL,parLH,parHH]=getModelParam_cell_RDK(mod_feature,4,param);%#ok
...
%%     
    ...
    [pmod_LL,foo1,qobs{1}]=mod_stats_sim('LBA_spec_c_even_template',parLL,1,goalstat_LL.allObs(:,1),4,0); %#ok ,goalstat_spec_norep.cond_ratio);
    ...
    [pmod_HL,foo2,qobs{2}]=mod_stats_sim('LBA_spec_c_even_template',parHL,1,goalstat_HL.allObs(:,1),4,0); %#ok ,goalstat_spec_norep.cond_ratio);
