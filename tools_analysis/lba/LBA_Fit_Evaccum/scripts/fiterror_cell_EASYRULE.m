function [f_error, BIC, pmod_LL,pmod_HL,priorMod_HA,qobs] = fiterror_cell_EASYRULE(param, mod_feature, data2fit)
...
[num_param,parLL,parHL,~,~]=getModelParam_cell_RDK(mod_feature,2,param);
